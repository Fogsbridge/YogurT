<template>
  <div v-if="show">
    <Teleport :disabled="!show" to="body">
      <div class="fixed bg-black/65 inset-0 z-1000 before:backdrop-blur-xs before:absolute before:inset-0 before:-z-1">
...
import { useDraggable, useThrottleFn, useWindowSize } from '@vueuse/core'
