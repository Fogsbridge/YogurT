<template>
  <BannerContainer mode="immersive" imgUrl="/images/banner/banner-2.jpg" class="h-screen">
    <!-- 点阵遮罩 -->
    <div class="absolute -z-1 inset-0 dot-mask transition duration-500"></div>

    <div class="-mt-16 h-full flex flex-col justify-center items-center select-none text-white/95 dark:text-white/85 text-shadow-black/50 text-shadow-lg transition-all duration-500">
      <img src="/images/avatar-1.jpg" alt="avatar" class="size-28 mb-8 rounded-full ring-base-100/20 ring-6 opacity-90 shadow-black/80 shadow-2xl" />
      <span class="text-3xl md:text-4xl lg:text-5xl mb-6 font-bold">云桥雾的Blog</span>
      <div class="h-5 md:h-6 lg:h-7.5 text-xl md:text-2xl lg:text-3xl mb-10">
    ...
    <div class="absolute bottom-0 w-full flex justify-center mb-10 animate-bounce cursor-pointer" @click="scrollToMain">
